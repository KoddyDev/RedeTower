...
module.exports = {
 ...
 const canal = interaction.options.get("canal").channel
                ...
                if(!canal){
                    ...
                    interaction.editReply('<:alerta_h:854929287525957642> Qual o título do anúncio?').then(msg2 => {
                        ...
                        .on('collect', c => {
                            ...
                            interaction.channel.send({
                                content: '<:alerta_h:854929287525957642 Qual o anúncio?',
                                reply: {
                                ...
                                .on('collect', c => {
                                    ...
                                    interaction.channel.send({
                                        content: '<:aviso:854929386394615848> Anúncio enviado com sucesso!',
                                        reply: {
                                            messageReference: c.id
                                        }
                                    })
